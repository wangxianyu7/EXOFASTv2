...
endelse
   ...
   ss.planet[i].lambda.value = atan(ss.planet[i].svsinisinlambda.value,ss.planet[i].svsinicoslambda.value)
   ss.planet[i].lambdadeg.value = ss.planet[i].lambda.value*180d0/!dpi
   ss.planet[i].vsini.value = ss.planet[i].svsinicoslambda.value^2 + ss.planet[i].svsinisinlambda.value^2
